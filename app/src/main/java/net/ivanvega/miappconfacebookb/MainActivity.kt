...
LoginManager.getInstance().logInWithReadPermissions(this, listOf("email"))
        ...
        //Para poder visualizar el boton
        shLink = findViewById(R.id.btnCompartir)
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        val shareLinkContent = ShareLinkContent.Builder()
            .setContentUrl(Uri.parse("https://youtu.be/HYaTf4HdSGA"))
            .setShareHashtag(ShareHashtag.Builder().setHashtag("prueba").build())
            .build()
